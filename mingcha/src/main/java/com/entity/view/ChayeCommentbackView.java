...
public class ChayeCommentbackView extends ChayeCommentbackEntity implements Serializable {
	...
	public ChayeCommentbackView() {

	}

	public ChayeCommentbackView(ChayeCommentbackEntity chayeCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, chayeCommentbackEntity);
