<template>
    <view class="content">
        ...
        <view class="list">
                ...
                <view @tap="onPageTap('../recharge/recharge')" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","backgroundColor":"#fff","borderColor":"rgba(216, 216, 216, 1)","borderRadius":"0","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"solid","height":"80rpx"}' class="li" hover-class="hover">
