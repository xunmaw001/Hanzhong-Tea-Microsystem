        ...
        <form class="app-update-pv">
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">茶叶</view>
                    <picker @change="chayeChange" :value="chayeIndex" :range="chayeOptions" range-key="chayeName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.chayeId?ruleForm.chayeName:"请选择茶叶"}}</view>
                    </picker>
                </view>-->
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">类型</view>
                    <picker @change="chayeCollectionTypesChange" :value="chayeCollectionTypesIndex" :range="chayeCollectionTypesOptions" range-key="indexName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.chayeCollectionTypes?ruleForm.chayeCollectionValue:"请选择类型"}}</view>
                    </picker>
                </view>
...
<script>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            let chayeData = await this.$api.page(`chaye`, chayeParams);
            this.chayeOptions = chayeData.data.list;
            let yonghuParams = {
                page: 1,
                limit: 100,
            }
		...
		/*下拉框*/
			let chayeCollectionTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'chaye_collection_types',
            }
			let chayeCollectionTypes = await this.$api.page(`dictionary`, chayeCollectionTypesParams);
			this.chayeCollectionTypesOptions = chayeCollectionTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`chayeCollection`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.chayeCollectionId){
                this.ruleForm.chayeCollectionId = options.chayeCollectionId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
                if (this.ruleForm.id) {
                    await this.$api.update(`chayeCollection`, this.ruleForm);
                } else {
                    await this.$api.save(`chayeCollection`, this.ruleForm);
                }
